 ...
 * Source Class_ HadithChapter <br>
 * @version generated on Sun Jan 09 12_58_46 PKT 2022 by amna
 */

public interface HadithChapter extends WrappedIndividual {

    /* ***************************************************
     * Property http://www.semantichadith.com/ontology/hasHadith
     */
     
    /**
     * Gets all property values for the hasHadith property.<p>
     * 
     * @returns a collection of values for the hasHadith property.
     */
    Collection<? extends Hadith> getHasHadith();

    /**
     * Checks if the class has a hasHadith property value.<p>
     * 
     * @return true if there is a hasHadith property value.
     */
    boolean hasHasHadith();

    /**
     * Adds a hasHadith property value.<p>
     * 
     * @param newHasHadith the hasHadith property value to be added
     */
    void addHasHadith(Hadith newHasHadith);

    /**
     * Removes a hasHadith property value.<p>
     * 
     * @param oldHasHadith the hasHadith property value to be removed.
     */
    void removeHasHadith(Hadith oldHasHadith);
    ...
    /* ***************************************************
     * Property http://www.semantichadith.com/ontology/hasRootNarratorOccurrence
     */
    ...
    /* ***************************************************
     * Property http://www.semantichadith.com/ontology/isPartOfBook
     */
     
    /**
     * Gets all property values for the isPartOfBook property.<p>
     * 
     * @returns a collection of values for the isPartOfBook property.
     */
    Collection<? extends HadithBook> getIsPartOfBook();

    /**
     * Checks if the class has a isPartOfBook property value.<p>
     * 
     * @return true if there is a isPartOfBook property value.
     */
    boolean hasIsPartOfBook();

    /**
     * Adds a isPartOfBook property value.<p>
     * 
     * @param newIsPartOfBook the isPartOfBook property value to be added
     */
    void addIsPartOfBook(HadithBook newIsPartOfBook);

    /**
     * Removes a isPartOfBook property value.<p>
     * 
     * @param oldIsPartOfBook the isPartOfBook property value to be removed.
     */
    void removeIsPartOfBook(HadithBook oldIsPartOfBook);
