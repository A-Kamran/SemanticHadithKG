...
public class HadithFactory implements CodeGenerationFactory {
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Person", Person.class, DefaultPerson.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Believer", Believer.class, DefaultBeliever.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Companion", Companion.class, DefaultCompanion.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Elevated_Hadith", Elevated_Hadith.class, DefaultElevated_Hadith.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Hadith", Hadith.class, DefaultHadith.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/HadithBook", HadithBook.class, DefaultHadithBook.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/HadithChapter", HadithChapter.class, DefaultHadithChapter.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/HadithCollection", HadithCollection.class, DefaultHadithCollection.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/HadithCollectionAuthor", HadithCollectionAuthor.class, DefaultHadithCollectionAuthor.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/HadithNarrator", HadithNarrator.class, DefaultHadithNarrator.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/HadithText", HadithText.class, DefaultHadithText.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/HadithType", HadithType.class, DefaultHadithType.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/NarratorChain", NarratorChain.class, DefaultNarratorChain.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/NarratorChainSegment", NarratorChainSegment.class, DefaultNarratorChainSegment.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/RootNarrator", RootNarrator.class, DefaultRootNarrator.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/RootNarratorChainSegment", RootNarratorChainSegment.class, DefaultRootNarratorChainSegment.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Sacred_Hadith", Sacred_Hadith.class, DefaultSacred_Hadith.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Severed_Hadith", Severed_Hadith.class, DefaultSevered_Hadith.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Stopped_Hadith", Stopped_Hadith.class, DefaultStopped_Hadith.class);
    }
    ...
    {
        javaMapping.add("http://www.semantichadith.com/ontology/Verse", Verse.class, DefaultVerse.class);
    }
