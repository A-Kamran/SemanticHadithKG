 ...
 * Source Class_ NarratorChain <br>
 * @version generated on Sun Jan 09 12_58_47 PKT 2022 by amna
 */

public interface NarratorChain extends WrappedIndividual {
    ...
    /* ***************************************************
     * Property http://www.semantichadith.com/ontology/hasNarratorChainSegment
     */
     
    /**
     * Gets all property values for the hasNarratorChainSegment property.<p>
     * 
     * @returns a collection of values for the hasNarratorChainSegment property.
     */
    Collection<? extends NarratorChainSegment> getHasNarratorChainSegment();

    /**
     * Checks if the class has a hasNarratorChainSegment property value.<p>
     * 
     * @return true if there is a hasNarratorChainSegment property value.
     */
    boolean hasHasNarratorChainSegment();

    /**
     * Adds a hasNarratorChainSegment property value.<p>
     * 
     * @param newHasNarratorChainSegment the hasNarratorChainSegment property value to be added
     */
    void addHasNarratorChainSegment(NarratorChainSegment newHasNarratorChainSegment);

    /**
     * Removes a hasNarratorChainSegment property value.<p>
     * 
     * @param oldHasNarratorChainSegment the hasNarratorChainSegment property value to be removed.
     */
    void removeHasNarratorChainSegment(NarratorChainSegment oldHasNarratorChainSegment);
    ...
    /* ***************************************************
     * Property http://www.semantichadith.com/ontology/isPartOfHadith
     */
     
    /**
     * Gets all property values for the isPartOfHadith property.<p>
     * 
     * @returns a collection of values for the isPartOfHadith property.
     */
    Collection<? extends Hadith> getIsPartOfHadith();

    /**
     * Checks if the class has a isPartOfHadith property value.<p>
     * 
     * @return true if there is a isPartOfHadith property value.
     */
    boolean hasIsPartOfHadith();

    /**
     * Adds a isPartOfHadith property value.<p>
     * 
     * @param newIsPartOfHadith the isPartOfHadith property value to be added
     */
    void addIsPartOfHadith(Hadith newIsPartOfHadith);

    /**
     * Removes a isPartOfHadith property value.<p>
     * 
     * @param oldIsPartOfHadith the isPartOfHadith property value to be removed.
     */
    void removeIsPartOfHadith(Hadith oldIsPartOfHadith);
